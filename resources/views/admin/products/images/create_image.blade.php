...
@section('title')
{{ trans('products.Product pictures') }}
@endsection
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> {{ trans('products.Product pictures') }}
                                ...
                                <div class="card-body">
                                    <form class="form"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <h4 class="form-section"><i class="ft-home"></i> {{ trans('products.Product pictures') }}
                                            </h4>
                                            <div class="form-group">
                                                <div id="dpz-multiple-files" class="dropzone dropzone-area">
                                                    <div class="dz-message">{{ trans('products.You can upload more than one picture here') }}
                                                    </div>
                                                </div>
                                                <br><br>
                                            </div>
...
<script>
    ...
    Dropzone.options.dpzMultipleFiles = {
        ...
        ,
        url: "{{ route('image_in_folder') }}", // Set the url
        success:
