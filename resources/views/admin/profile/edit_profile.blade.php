                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('update_profile') }}"
                                              method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ auth('admin')->user()->gettranslation('name','ar') }}" id="name"
                                                                   class="form-control"
                                                                   placeholder=""
                                                                   name="name_ar">
                                                            @error("name_ar")
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ auth('admin')->user()->gettranslation('name','en') }}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name_en">
                                                            @error("name_en")
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ auth('admin')->user()->email }}" id=""
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="email">
                                                            @error("email")
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" value="{{ auth('admin')->user()->password }}" id=""
                                                                   class="form-control"
                                                                   placeholder=""
                                                                   name="password">
                                                            @error("password")
