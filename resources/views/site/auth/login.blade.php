                                ...
                                <section>
                                    <div class="form-group row no-gutters">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" name="mobile_user" value="{{ old('mobile') }}"
                                                   type="text" required="">
                                            @error('mobile_user')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group js-parent-focus">
                                                <input class="form-control js-child-focus js-visible-password"
                                                       name="password_user" type="password" value="" pattern=".{5,}"
                                                       required="">
                        ...
                        <div class="row no-gutters">
                            <div class="col-md-10 offset-md-2">
                                <div class="no-account">
                                    <a href="{{ route('user_register') }}" data-link-action="display-register-form">
