            ...
            <div class="modal-body">
                <div class="row no-gutters">
                    <div class="col-md-5 col-sm-5 divide-right">
                        <div class="images-container bottom_thumb">
                            <div class="product-cover">
                                <img class="js-qv-product-cover img-fluid" src="{{get_images($product ->images[0]->image_name) ??''}}" alt="" title="" style="width:100%;" itemprop="image">
                    ...
                    <div class="col-md-7 col-sm-7">
                        <h1 class="product-name">{{get_trans($product)}}</h1>
