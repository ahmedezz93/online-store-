            ...
            <div id="content-wrapper" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <section id="main">
                        <div class="block-category hidden-sm-down">
                            {{-- <h1 class="h1">{{ get_trans($section) ?? ''}} </h1> --}}
                        </div>
                            ...
                            <div id="js-product-list-top" class="row products-selection">
                                <div class="col-md-6 col-xs-6">
                                    ...
                                    <div class="hidden-sm-down total-products">
                                        {{-- <p>{{ trans('site/home.available') }} {{ $section->products->count() ??'0' }} {{ trans('site/home.product') }}.</p> --}}
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-6">
                            ...
                            <div id="js-product-list">
                                <div class="products product_list grid row" data-default-view="grid">
                                    ...
                                    @forelse($products as $product)
                                                    ...
                                                    <div class="product-description">
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                <div class="product-price-and-shipping">
                                                                    <span itemprop="price"
                                                                          class="price">{{ number_format($product->special_price)?? number_format($product->price,2) }}</span>
                                                                    @if($product->special_price)
                                                                        <span
                                                                            class="regular-price">{{ number_format($product->price,2) }}</span>
                                                                    @endif
                                                        ...
                                                        <div class="product-buttons d-flex justify-content-center"
                                                            ...
                                                            <form
                                                                ...
                                                                <a class="add-to-cart cart-addition" data-product-id="{{ $product->id}}"  href="#"
                                            ...
                                            @include('site.products.product_details',$product);
                                            @empty

                                           <h3>{{ trans('messages.data not found') }}</h3>
                                            @endforelse
                                            @endisset
